...
<Fragment>
    ...
    <span classNameName='fa fa-sign-in me-1'></span>   Login
    </button>
    ...
    <div className="modal-content">
        ...
        <div className="modal-body ">
            <button classNameName='btn btn-primary w-100 mb-4'> 
                <span classNameName='fa fa-google me-2'></span>
                Sign in with Google 
            </button>
            <button className='btn btn-primary w-100 mb-4'> 
                <span classNameName='fa fa-facebook me-2'></span>
